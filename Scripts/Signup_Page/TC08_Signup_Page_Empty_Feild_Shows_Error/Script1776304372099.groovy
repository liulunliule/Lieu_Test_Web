...
WebUI.openBrowser('http://localhost:5173/signup')

WebUI.setText(findTestObject('Page_Signup/txt_name'), '')

WebUI.setText(findTestObject('Login_Page/txt_email'), '')

WebUI.setText(findTestObject('Login_Page/txt_pass'), '')

WebUI.setText(findTestObject('Page_Signup/txt_password'), '')
