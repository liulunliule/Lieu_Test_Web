...
WebUI.setText(findTestObject('Page_Signup/txt_confirmPassword'), '678900')
...
//XH trong HTML
WebUI.verifyTextPresent('Mật khẩu và xác nhận mật khẩu không khớp', true)

//WebUI.verifyTextPresent('Đăng ký thành công! Chuyển về trang chủ...', true)
WebUI.delay(0.5 //delay UI
    )

boolean found = WebUI.verifyTextPresent('Mật khẩu và xác nhận mật khẩu không khớp', false, FailureHandling.CONTINUE_ON_FAILURE)
